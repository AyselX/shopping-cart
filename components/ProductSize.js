...
import CounterController from "./utilities/CounterController";
  ...
  return (
    <div className="border border-bright-gray rounded h-min w-full px-2 my-2 py-2">
      <div className="flex flex-row justify-around">
        ...
        <div className="flex flex-col">
          <p>Adet</p>
          <div className="flex flex-row border border-platinum  w-min h-min px-4 py-1.5 my-1">
      <button className="pr-2 text-base">+</button>
      <button className="border-x border-platinum bg-snow px-3 text-base">1</button>
      <button className="pl-2 text-base">+</button>
    </div>
        </div>

        <div className="flex flex-col justify-end">
          <button className="border border-platinum py-2.5 mb-1 rounded flex justify-center">
        ...
        <div className="flex flex-col justify-end">
          <button className="border border-platinum py-2.5 mb-1 rounded flex justify-center">
            <figure className="w-4 h-4">
                <Image src={favIcon} width={10} height={10} objectFit="cover" layout="responsive" alt="bell"  />
            </figure>
          </button>
